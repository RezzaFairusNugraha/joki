...
class SiswaSekolahController extends Controller
{
    public function index()
    {
        ...
        return view('siswa_sekolah.index', compact('list'));
    }

    public function create()
    {
        $kelas = KelasSekolah::all();
        return view('siswa_sekolah.tambah', compact('kelas'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $item->save();
        return redirect()->route('siswa_sekolah.index')->with('pesan', 'Data siswa disimpan!');
    }
    ...
    public function edit($id)
    {
        ...
        $kelas = KelasSekolah::all();
        return view('siswa_sekolah.edit', compact('item', 'kelas'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $item->no_hp_siswa = $request->no_hp_siswa;
        $item->save();
        return redirect()->route('siswa_sekolah.index')->with('pesan', 'Data siswa diupdate!');
    }

    public function destroy($id)
    {
        SiswaSekolah::destroy($id);
        return redirect()->route('siswa_sekolah.index')->with('pesan', 'Data siswa dihapus!');
    }
}
