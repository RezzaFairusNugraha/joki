    ...
    <div class="wrapper">
        ...
        <div class="content">
            <h2 class="d-flex justify-content-between">
                Data Guru
                <a href="/pengajar/create" class="btn btn-primary btn-sm">Tambah Guru</a>
            </h2>
            <hr>
            ...
            <table class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $g->jk }}</td>
                        <td>
                            <a href="/Pengajar/{{ $g->id_pengajar }}/edit" class="btn btn-sm btn-warning">Edit</a>
                            <form action="/Pengajar/{{ $g->id_pengajar }}" method="POST" style="display:inline;" onsubmit="return confirm('Yakin hapus?')">
                                @csrf
                                @method('DELETE')
