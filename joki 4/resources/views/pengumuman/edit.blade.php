...
<html>
<head>
    <title>SIAKAD - Edit Berita</title>
...
<body>
    <div class="wrapper">
        ...
        <div class="content">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="/pengumuman/{{ $berita->id_pengumuman }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="mb-3">
                            ...
                            <select name="id_pengajar" class="form-control">
                                ...
                                @foreach($gurus as $g)
                                    <option value="{{ $g->id_pengajar }}" {{ $berita->id_pengajar == $g->id_pengajar ? 'selected' : '' }}>{{ $g->nama }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="mb-3">
