...
<body>
    <div class="wrapper">
        ...
        <div class="content">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="/kelas_sekolah/{{ $kela->id_kelas }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="mb-3">
                            <label>Nama Kelas</label>
                            <input type="text" name="nama_kelas" value="{{ $kela->nama_kelas }}" class="form-control" required>
                        </div>
                        <div class="mb-3">
                            <label>Jurusan</label>
                            <input type="text" name="jurusan_kelas" value="{{ $kela->jurusan_kelas }}" class="form-control" required>
                        </div>
                        <button type="submit" class="btn btn-primary">Update</button>
                        <a href="/kelas_sekolah" class="btn btn-secondary">Kembali</a>
                    </form>
                </div>
            </div>
        </div>
